...
import 'package:login_support/SupportTeam/HomePageSupport.dart';
import 'package:login_support/Teacher/HomePageTeacher.dart';
import 'package:login_support/Student/HomePageStudent.dart';
                ...
                onPressed: () {
                  ...
                  if (pushes == 1) {
                    ...
                    Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const HomePageSupport()));
                  } else if (pushes == 2) {
                    Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const HomePageTeacher()));
                  } else if (pushes == 3) {
                    Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
