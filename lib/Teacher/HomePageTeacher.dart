...
import 'package:login_support/Teacher/AddTextToClass.dart';
import 'package:login_support/Teacher/AllReport.dart';
import 'package:login_support/Teacher/ReportIndivucial.dart';
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const AddTextToClassTeacher(),
              ...
              onPressed: () {
                if (currentName == "") {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const ReportIndivucialTeacher(),
                        settings: RouteSettings(
